...
* Fixed support in `MichaelKaefer\GuzzleHttp6ForPrestashop17\GuzzleHttp\Psr7\CachingStream` for seeking forward on remote
...
- `MichaelKaefer\GuzzleHttp6ForPrestashop17\Psr\Http\Message\ServerRequestInterface`
- `MichaelKaefer\GuzzleHttp6ForPrestashop17\Psr\Http\Message\UploadedFileInterface`
